    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[50vh] min-h-[400px]">
          <Image
            src={camphorGarlands[0]?.images?.[0] || "/images/garlands.jpg"}
            alt="Camphor Garlands"
            fill
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-serif text-4xl font-bold text-card sm:text-5xl">Camphor Garlands</h1>
                  <p className="mt-1 text-lg text-card/80">Beautiful camphor garlands for traditional ceremonies</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
              <h2 className="font-serif text-2xl font-bold text-foreground">
                Our Camphor Garland Collection
              </h2>
              <p className="mt-1 text-muted-foreground">
                {camphorGarlands.length} beautiful camphor garlands to choose from
              </p>
            </div>

            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {camphorGarlands.map((garland) => (
                <CamphorGarlandCard key={garland.id} garland={garland} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="bg-primary py-12">
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="font-serif text-2xl font-bold text-primary-foreground sm:text-3xl">Custom Camphor Garlands</h2>
