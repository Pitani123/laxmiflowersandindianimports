...
import { Phone, Store, ArrowLeft, Gift } from "lucide-react"

export default async function GiftItemsPage() {
  const products = await getProductsByCategory("gift-items")
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-serif text-4xl font-bold text-card sm:text-5xl">Indian Gift Items</h1>
                  <p className="mt-1 text-lg text-card/80">Traditional Indian gifts and puja items</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 flex flex-col gap-4 rounded-xl bg-secondary p-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="font-medium text-foreground">Perfect gifts for every occasion. Gift wrapping available.</p>
              </div>
