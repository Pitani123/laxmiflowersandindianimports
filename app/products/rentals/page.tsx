...
import { Phone, Store, ArrowLeft, Package } from "lucide-react"
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 flex flex-col gap-4 rounded-xl bg-secondary p-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="font-medium text-foreground">Book in advance to ensure availability. Delivery available.</p>
              </div>
        ...
        <section className="bg-primary py-12">
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="font-serif text-2xl font-bold text-primary-foreground sm:text-3xl">Delivery & Setup Available</h2>
            <p className="mt-2 text-primary-foreground/80">We offer delivery and professional setup for all rental items.</p>
