          ...
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-serif text-4xl font-bold text-card sm:text-5xl">Loose Flowers</h1>
                  <p className="mt-1 text-lg text-card/80">Fresh loose flowers for daily pooja and home decoration</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {products.length > 0 ? (
              ...
              <div className="rounded-xl bg-secondary p-12 text-center">
                ...
                <p className="mt-2 text-muted-foreground">We are adding loose flowers to our collection. Please check back soon or call us for availability.</p>
