      ...
      <main className="flex-1">
        ...
        <section className="relative h-[50vh] min-h-[400px]">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
              <Link href="/products/fresh-flowers" className="mb-4 inline-flex items-center gap-2 text-sm text-card/80 hover:text-card">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-serif text-4xl font-bold text-card sm:text-5xl">Pooja Garlands</h1>
                  <p className="mt-1 text-lg text-card/80">Traditional garlands for temple and pooja ceremonies</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {products.length > 0 ? (
              ...
              <div className="rounded-xl bg-secondary p-12 text-center">
                ...
                <p className="mt-2 text-muted-foreground">We are adding pooja garlands to our collection. Please check back soon or call us for availability.</p>
        ...
        <section className="bg-primary py-12">
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="font-serif text-2xl font-bold text-primary-foreground sm:text-3xl">Custom Pooja Garlands</h2>
            <p className="mt-2 text-primary-foreground/80">We create custom garlands for special pooja occasions. Order in advance for best results.</p>
