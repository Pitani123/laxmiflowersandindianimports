      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 flex flex-col gap-4 rounded-xl bg-secondary p-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                <p className="font-medium text-foreground">Fresh festival snacks made to order. Call for bulk orders.</p>
              </div>
        ...
        <section className="bg-primary py-12">
          <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className="mt-2 text-primary-foreground/80">Planning a big celebration? We offer special pricing for bulk festival orders.</p>
