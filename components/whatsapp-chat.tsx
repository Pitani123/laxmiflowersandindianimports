...
const WHATSAPP_NUMBER = "14699889029"
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-lg font-semibold">Chat with Us</DialogTitle>
                <DialogDescription className="text-sm text-muted-foreground">
                  Enter your details to start a WhatsApp conversation
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
